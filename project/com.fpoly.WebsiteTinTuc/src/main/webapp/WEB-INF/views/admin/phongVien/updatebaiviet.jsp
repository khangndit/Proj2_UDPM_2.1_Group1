		...
		<div class="app-sidebar__inner ">
			<ul class="vertical-nav-menu">
				...
				<li><a href="#"> <i class="metismenu-icon fa fa-user"></i>
					...
					<ul>
						<li ><a href="/phongvien/createnews"> <i
								class="metismenu-icon"></i> THÊM BÀI VIẾT MỚI
						</a></li>
						<li class="mm-active"><a href="/phongvien/thongtin"> <i class="metismenu-icon"></i>
								QUẢN LÝ BÀI VIẾT
						</a></li>
					</ul></li>
			</ul>
...
<div class="app-main__outer">
	...
	<div class="app-main__inner">
		...
		<div class="col md-12">
			<form:form action="/phongvien/update"  modelAttribute="form"
				enctype="multipart/form-data">
				<div class="form-row">
				
					<div class="form-group col-md-8">
						 <input type="hidden"
							class="form-control" id="inputState" name="id" 
							value="${form.id}" />
					</div>
					
					<div class="form-group col-md-8">
						<label style="font-weight: bold; font-size: 15px" for="inputState"> Tiêu đề</label>
				...
				<div class="form-group">
					...
					<form:input type="text" class="form-control"
						id="formGroupExampleInput2" path="summary"  />
				...
				<div class="form-group">
						...
						<input type="file"  name="images" onchange="openFile(this)"
							class="form-control-file">
							<div class="images-anh" id="anh"></div>
							<form:hidden path="imagestitle"/>
					</div>
				<div class="form-group">
					<div id="sample">
