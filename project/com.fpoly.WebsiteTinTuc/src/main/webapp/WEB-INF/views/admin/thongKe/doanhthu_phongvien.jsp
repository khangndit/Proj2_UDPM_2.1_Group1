				...
				<li><a href="#"> <i class="metismenu-icon fa fa-pie-chart"></i>
					...
					<ul>
						<li><a href="#"> <i class="metismenu-icon pe-7s-diamond"></i>
							...
							<ul>
								<li class="mm-active"><a style="font-size: 12px" href="tkphongvien"> <i
		...
		<div class="app-page-title" style="height: 80px;">
			<div class="page-title-wrapper">
				<div class="page-title-heading">
					<h3>THỐNG KÊ DOANH THU PHÓNG VIÊN</h3>
				</div>
			</div>
		</div>
					...
					<div class="col-sm-12">
						<div class="main-card mb-3 card">
							<div class="card-body">
										...
										<tbody>
											<c:forEach var="array" items="${views}">
												<tr>
													...
													<td>
         											 <fmt:formatNumber type="number" value="${array[2]}" /> vnđ
													</td>
												</tr>
											</c:forEach>
										</tbody>
								...
								<script type="text/javascript">
									var mydata = [ [ 'Tên phóng viên', 'Tổng số tiền' ],
										<c:forEach var="array" items="${views}"> 
										[ "${array[0]}", ${array[2]} ],
										</c:forEach>
									]
