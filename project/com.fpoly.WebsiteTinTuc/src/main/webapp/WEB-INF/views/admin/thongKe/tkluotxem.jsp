			...
			<ul class="vertical-nav-menu">
				...
				<li><a href="#"> <i class="metismenu-icon fa fa-pie-chart"></i>
					...
					<ul>
						...
						<li class="mm-active"><a href="tkluotxem"> <i class="metismenu-icon"></i>LƯỢT
								XEM
						</a></li>
...
<div class="app-main__outer">
	<div class="app-main__inner">
		...
		<p>
			<button aria-expanded="false" data-toggle="collapse" data-target="#collapseExample"
				...
				<table class="table table-dark hover">
					<thead>
						<tr style="color: coral">
							...
							<th>Lượt xem ít nhất của danh mục</th>
							<th>Lượt xem nhiều nhất của danh mục</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="array" items="${views}">
							<tr>
								<td>${array[0]}</td>
								<td>${array[1]} lượt xem</td>
								<td>${array[2]} lượt xem</td>
								<td>${array[3]} lượt xem</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
