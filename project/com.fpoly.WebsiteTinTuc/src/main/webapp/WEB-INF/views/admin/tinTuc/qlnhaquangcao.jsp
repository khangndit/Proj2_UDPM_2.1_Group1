		...
		<div class="app-sidebar__inner ">
			...
			<li><a href="#"> <i class="metismenu-icon fa fa-user"></i>
				...
				<ul>
					...
					<li class="mm-active"><a href="nhaquangcao"> <i class="metismenu-icon"></i>
		...
		<div class="app-page-title" style="height: 80px;">
			<div class="page-title-wrapper">
				<div class="page-title-heading">
					<h3>DANH SÁCH THÔNG TIN NHÀ QUẢNG CÁO</h3>
				</div>
			</div>
		</div>
		<div>
			...
			<table class="table table-striped table-dark table-hover">
				<thead>
					<tr style="color: coral">
						<th scope="col">Tên nhà quảng cáo</th>
