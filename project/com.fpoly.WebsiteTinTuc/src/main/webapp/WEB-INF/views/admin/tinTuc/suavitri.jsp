			...
			<ul class="vertical-nav-menu">
				...
				<li><a href="#"> <i
					...
					<ul>
						...
						<li class="mm-active"><a href="/admin/quangcao"><i class="metismenu-icon"> </i>QUẢN
								LÝ QUẢNG CÁO </a></li>
					</ul></li>
				<!-- thống kê -->
			...
			<div class="form-group row" hidden>
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="inputEmail3"
						placeholder="ID" value="${position.id}" name="id" readonly="readonly" >
				</div>
			</div>	
			<div class="form-group row">
				<label style="font-weight: bold; font-size: 15px" for="inputEmail3" class="col-sm-2 col-form-label">Tên vị trí </label>
				<div class="col-sm-10">
					<input type="text" name="positionName" class="form-control" id="inputEmail3"
						placeholder="nhập tên vị trí" value="${position.positionName}" required="required" />
				</div>
			</div>
			<div class="form-group row">
				<label style="font-weight: bold; font-size: 15px" for="inputEmail3" class="col-sm-2 col-form-label">Giá tiền </label>
				<div class="col-sm-10">
					<input type="text" value="${position.price}" name="price" class="form-control" id="inputEmail3" placeholder="Nhập giá" required="required">
				</div>
			</div>
			<a class="btn btn-secondary btn-lg" href="/admin/themvitri" style="color: white;"  aria-hidden="true">QUAY LẠI</a>
			<button formaction="/admin/updatePosition" type="submit"
