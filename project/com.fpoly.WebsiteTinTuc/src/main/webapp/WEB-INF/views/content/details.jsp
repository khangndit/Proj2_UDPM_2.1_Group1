...
<div class="row">
	<div class="col-sm-8">
		<div style="background-color: white !important; margin-top: 5px">
			<div class="container" style="margin-top: 8px; border: 1px solid; border-radius: 5px;">
...
<div class="row">
	<div class="col-md-8">
		<div ng-app="app" ng-controller="ctrl">
			<div class="user-comment mt-3 mb-3" style="border: 1px solid olivedrab; padding: 10px; border-radius: 5px;">
			<p style="font-weight: bold;">Bình luận</p>
				<div class="comments-section">
					...
					<div style="margin-top: 40px; background-color: white !important; border-radius: 5px; border: 1px solid wheat;" >
						<ul>
								...
								<div class="comment-post">
									<div class="comment-img">
										...
										<div style="margin-left: 45px">
											...
											<textarea rows="2" cols="74" placeholder="Nhập nội dung bình luận . . ." ng-model="reply.text"></textarea>
											<a style="margin-top: 14px; margin-right: 10px;"
